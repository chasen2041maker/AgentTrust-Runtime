...
def test_public_security_dataset_has_exactly_one_hundred_cases() -> None:
...
def test_security_benchmark_detects_every_expected_attack(tmp_path) -> None:
    ...
    assert all(result.detected_block for result in report.results)
