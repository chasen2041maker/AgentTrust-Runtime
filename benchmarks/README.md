...
`security-v1` is a deterministic, local 100-case adversarial benchmark. It never runs a supplied shell command and never starts an MCP server; each case directly exercises the runtime control that should block it.
